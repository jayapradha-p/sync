# sdsdssdsGoogle Chronicle - Chronicle Alerts Connector
...
|Verify SSL|If enabled, verify the SSL certificate for the connection to the Google Chronicle server is valid.|False|false|
