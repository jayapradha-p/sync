...
|API Root|API root of the ArcSight instance.|True|https://1.1.1.1|
|Username|Username of the ArcSight account.|True|fdfd|
|Password|Password of the ArcSight account.|True|*****|
|Report Name|Name of the report that will be used to fetch events.|True|dfd|
