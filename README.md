...
|AlienVaultTI|AlienVaultTI - Powerful Threat Detection, Incident Response & Compliance in One Solution.|
...
|Atlassian Confluence Server|Confluence is a collaboration tool that brings people, knowledge, and ideas together in a shared workspace, so you can do your best work with the confidence of your entire organization's expertise behind you. This integration is working with the server deployment option (self hosted).|
...
|Cynet|The Cynet 360 platform provides advanced threat detection, prevention and response.|
...
|DUO|Cisco's MFA Solution. Duo is engineered to provide a simple, streamlined login experience for every user and application, and as a cloud-based solution, it integrates easily with your existing technology.|
...
|Docker Hub|Docker is a tool designed to make it easier to create, deploy, and run applications by using containers. Containers allow a developer to package up an application with all of the parts it needs, such as libraries and other dependencies, and deploy it as one package.|
...
|IPQS Fraud and Risk Scoring|IPQS Fraud and Risk Scoring provides enterprise grade fraud prevention, risk analysis, and threat detection. Analyze IP addresses, email addresses, and URLs or domains to identify sophisticated bad actors and high risk behavior.|
...
|MobileIron|MobileIron's mobile device management (MDM) capabilities give you the fundamental visibility and IT controls needed to secure, manage, and monitor any corporate- or employee-owned mobile device or desktop that accesses business critical data.|
...
|Protectwise|ProtectWise™ provides automated network detection and response across time for any network.|
|Reversinglabs A1000|The A1000 Malware Analysis Platform supports advanced hunting and investigations through high-speed automated static analysis.|
...
|Trend Micro DDAN|Deep Discovery Analyzer extends the value of existing security investments from Trend Micro and third-parties (through a web services API) by providing custom sandboxing and advanced analysis.|
|Trend Micro Deep Security|Hybrid cloud security that matches the performance and flexibility of today's virtualised data centre|
|Palo Alto Wildfire|Cloud-based threat analysis and prevention engine for highly evasive zero-day exploits and malware.|
|Zendesk|Zendesk Support is a beautifully simple system for tracking, prioritizing, and solving customer support tickets.|
