...
|Lowest Score To Fetch|Lowest Score that needs to be used to fetch events.  Maximum: 10. If nothing is specified, connector will ingest events with all scores.|False|Int|5|
...
|Max Events To Fetch|How many alert logs to process per one connector iteration. Default: 100.|False|Int|100|
