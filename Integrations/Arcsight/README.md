...
|CA Certificate File|None||String||
...
|Additional Fields|Specify additional fields that should be added alongside the entity in the active list. Format is a JSON object. Example: {"Column_1": "Value_1","Column_2": "Value_2"}||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Columns|Specify the name of the columns, where you want to put values for the entries. Format: Column_name1;Column_name2||String||
|Entries|Specify the entries. Format entry1_value1|entry1_value2;entry2_value1|entry2_value2||String||
|Active List UUID|Specify the UUID of the active list, where you want to add new entries. Note: parameter “Active list UUID“ takes priority over “Active list name“. Example: HLZRc9yYBABC-lHtlf3-f0Q==||String||
|Active list name|Specify the name of the active list, where you want to add new entries. Note: parameter “Active list UUID“ takes priority over “Active list name“.||String||
|Entries JSON|Specify a list of JSON objects that contain information about the entry. Note: Combination of ‘Columns' and ‘Entries’ parameters have priority over 'Entries JSON’. Format: [{"Column_1": "Value_1", "Column_2": "Value_2"}, {"Column_1": "Value_3", "Column_2": "Value_4"}]||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Active list UUID|Specify the UUID of the active list for which you want to retrieve entries. Note: parameter “Active list UUID“ takes priority over “Active list name“. Example: HLZRc9yYBABC-lHtlf3-f0Q==||String||
|Active list name|Specify the name of the active list for which you want to retrieve entries. Note: parameter “Active list UUID“ takes priority over “Active list name“.||String||
|Map Columns|If enabled, action will map columns to the values in the JSON result.||Boolean|false|
|Max Entries To Return|Specify how many entries to return.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Query ID|Specify the ID of the query for which you want to return results. Note: parameter “Query ID“ takes priority over “Query Name“. Example: cyUJKRz4BABCFwS9iFPq+aA==||String||
|Max Items To Return|Specify how many items to return in the response.||String|100|
|Query Name|Specify the name of the query for which you want to return results. Note: parameter “Query ID“ takes priority over “Query Name“.||String||
...
|Field 2|The dynamic fields for the query to generate the report||String|None|
|Field 3|The dynamic fields for the query to generate the report||String|None|
|Field 4|The dynamic fields for the query to generate the report||String|None|
|Field 5|The dynamic fields for the query to generate the report||String|None|
|Field 6|The dynamic fields for the query to generate the report||String|None|
|Field 7|The dynamic fields for the query to generate the report||String|None|
|Field 8|The dynamic fields for the query to generate the report||String|None|
|Field 9|The dynamic fields for the query to generate the report||String|None|
|Field 10|The dynamic fields for the query to generate the report||String|None|
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Active list UUID|Specify the UUID of the active list, where you want to search for entities. Note: parameter “Active list UUID“ takes priority over “Active list name“. Example: HLZRc9yYBABC-lHtlf3-f0Q==||String||
|Column name|Specify the name of the column, where you want to search for the entity.|True|String||
|Active list name|Specify the name of the active list, where you want to search for entities. Note: parameter “Active list UUID“ takes priority over “Active list name“.||String||
...
|Name|Description|IsMandatory|Type|DefaultValue|
|----|-----------|-----------|----|------------|
|Return Active Lists|If enabled, action will return available active lists.||Boolean|true|
|Return Queries|If enabled, action will return available queries||Boolean|true|
|Return Cases|If enabled, action will return available cases.||Boolean|false|
|Return Reports|If enabled, action will return available reports.||Boolean|false|
|Max Resources To Return|Specify how many resources to return per type.||String|50|
...
|Fetch Base Events|If enabled, connector will also fetch base events.||Boolean|true|
|Lowest Priority To Fetch|Lowest priority that will be used to fetch events. Possible values are in range 1 to 10. If nothing is provided, all events will be ingested.||String||
|Max Events To Fetch|How many alerts to process per one connector iteration. Maximum is 1000.||Integer|100|
|Use dynamic list as a blocklist|If enabled, dynamic lists will be used as a blocklist.||Boolean|false|
|Verify SSL|If enabled, verify the SSL certificate for the connection to the ArcSight server is valid.||Boolean|false|
...
|EventClassId|The field name used to determine the event name (sub-type)||String|name|
...
|Secondary Device Product Field|Secondary field for Device Product||String|None|
|Alert Custom Fields Names|Additional fields that should be added to Siemplify Alert. Example: source_address||String|None|
...
|Proxy Password|The proxy password to authenticate with.||Password|*****|
|Verify SSL|If enabled, verify the SSL certificate for the connection to the ArcSight ESM server is valid.||Boolean|false|
|CA Certificate File|Base 64 encoded CA certificate file.||String||
