...
Mandiant Threat Intelligence is on a mission to make every organization secure from cyber threats and confident in their readiness. Mandiant delivers dynamic cyber defense solutions powered by industry-leading expertise, intelligence and innovative technology.
...
|API Root|API root of the Mandiant instance. Note: If you want to authenticate with GTI credentials provide "https://www.virustotal.com" as API Root.|True|String|https://api.intelligence.mandiant.com|
|Client ID|Client ID of the Mandiant Digital Threat Monitoring account.|False|String||
|Client Secret|Client Secret of the Mandiant Digital Threat Monitoring account.|False|Password|*****|
